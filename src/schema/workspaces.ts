import { DEFAULT_REDIRECTS } from "@/constants/config";
import { VALID_DOMAIN_REGEX, VALID_SLUG_REGEX } from "@/lib/functions/domains";
...
export const createWorkspaceSchema = z.object({
  ...
  slug: z
    ...
    .refine((v) => VALID_SLUG_REGEX.test(v), { message: "Invalid slug format" })
    .refine(
